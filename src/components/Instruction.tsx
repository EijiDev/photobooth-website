...
import boothImage from "../assets/booth-image.png"; 
      ...
      <div className="max-w-6xl mx-auto flex items-center justify-center gap-10">
              ...
              <div key={number} className="flex items-start gap-5">
                ...
                <div>
                  <p
                    ...
                    style={{ fontWeight: 700, color: dark ? "#f4f4f5" : "#111827" }}
                  >
                    {title}
                  </p>
                  <p
                    className="text-base leading-relaxed transition-colors duration-300"
                    style={{ fontWeight: 300, color: dark ? "#71717a" : "#6b7280" }}
                  >
                    {description}
                  </p>
                </div>
        ...
        <div className="shrink-0 flex relative">
          <div
            ...
            style={{ borderColor: dark ? "#2a2a2a" : "#e5e7eb", backgroundColor: "#1a1a1a" }}
          >
            <img
              src={boothImage}
              alt="Booth preview"
