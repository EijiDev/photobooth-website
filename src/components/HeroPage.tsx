...
export default function SnapBooth({ onStartBooth }: SnapBoothProps) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: dark ? "rgba(220,38,38,0.12)" : "rgba(254,202,202,0.5)" }}
      />
      <div
        className="absolute bottom-16 right-8 w-72 h-72 rounded-full blur-3xl pointer-events-none transition-colors duration-300"
        style={{ backgroundColor: dark ? "rgba(220,38,38,0.15)" : "rgba(252,165,165,0.25)" }}
      />

      <NavBar dark={dark} onToggleDark={toggleDark} onStartBooth={onStartBooth} />
      ...
      <main className="flex flex-col items-center justify-center text-center pt-20 pb-32 px-6 relative z-10">
        ...
        <h1
          ...
          style={{ fontWeight: 800, color: dark ? "#f4f4f5" : "#111827", opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(24px)", transitionDelay: "100ms" }}
        >
          Your personal
        </h1>
        <h1
          className="text-7xl leading-tight tracking-tight mb-8 transition-all duration-700"
          style={{ fontWeight: 800, opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(24px)", transitionDelay: "200ms" }}
        >
          <span
            style={{
              background: `linear-gradient(to right, #dc2626 0%, #fca5a5 40%, ${dark ? "#0f0f0f" : "#f8f8f8"} 100%)`,
        ...
        <p
          ...
          style={{ fontWeight: 300, color: dark ? "#71717a" : "#6b7280", opacity: mounted ? 1 : 0, transform: mounted ? "translateY(0)" : "translateY(24px)", transitionDelay: "300ms" }}
        >
